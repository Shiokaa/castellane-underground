...
func Telegram() {
	...
	fmt.Println("\nTaper 8 pour acheter un CASQUE ARAI : ")
	fmt.Println("\nTaper 9 pour acheter un TSHIRT NIKE TECH : ")
	fmt.Println("\nTaper 10 pour acheter un PANTALON NIKE TECH : ")
	fmt.Println("\nTaper 11 pour acheter une SACOCHE LV : ")
	fmt.Println("\nTaper 12 pour sortir du telegram")
	fmt.Scan(&achat)
